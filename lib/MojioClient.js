...
(function() {
  ...
  module.exports = MojioClient = (function() {
    ...
    */
    ...
    MojioClient.prototype.post_app = function(app_model, callback) {
      return this.request({
        method: 'POST',
    ...
    MojioClient.prototype.put_app = function(app_model, callback) {
      return this.request({
        method: 'PUT',
        resource: this.apps_resource,
        body: JSON.stringify(app_model)
    ...
    MojioClient.prototype.delete_app = function(id, callback) {
      return this.request({
        method: 'PUT',
        resource: this.apps_resource,
    ...
    MojioClient.prototype.make_app = function(json) {
      var object;
    ...
    MojioClient.prototype._apps = function(criteria, callback) {
      return this.request({
        method: 'GET',
        resource: this.apps_resource,
        parameters: criteria
    ...
    MojioClient.prototype.apps = function(criteria, callback) {
      var _this = this;
      return this._apps(criteria, function(error, result) {
        return callback(error, _this.make_app(result));
      });
    };

    MojioClient.prototype.app = function(id, callback) {
      var _this = this;
      return this.request({
        method: 'GET',
        resource: this.apps_resource,
