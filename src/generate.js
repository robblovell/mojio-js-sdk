      ...
      return fs.readFile('../test/TestTemplate.mustache', function(err, data) {
        ...
        return fs.readFile('../test/TestTemplate_Short.mustache', function(err, data) {
          ...
          for (model in result) {
            ...
            if (model !== "App" && model !== "Address" && model !== "Location" && model !== "Trip" && model !== "User" && model !== "Vehicle" && model !== "Event" && model !== "Mojio" && model !== "Subscription" && model !== "Product" && model !== "Observer" && model !== "AccelerationObserver" && model !== "AccelerometerObserver" && model !== "AltitudeObserver" && model !== "BatteryVoltageObserver" && model !== "ConditionalObserver" && model !== "DiagnosticCodeObserver" && model !== "DistanceObserver" && model !== "EventObserver" && model !== "FuelLevelObserver" && model !== "GeoFenceObserver" && model !== "HeadingObserver" && model !== "OdometerObserver" && model !== "RPMObserver" && model !== "ScriptObserver" && model !== "SpeedObserver") {
              continue;
            }
