...
(function() {
  var FormUrlencoded, Http, HttpNodeWrapper, Https, constants, iHttpWrapper, url,
  ...
  module.exports = HttpNodeWrapper = (function(superClass) {
    ...
    function HttpNodeWrapper(token1, uri1, encoding1) {
      this.token = token1;
      this.uri = uri1 != null ? uri1 : 'api.moj.io';
      this.encoding = encoding1 != null ? encoding1 : null;
      HttpNodeWrapper.__super__.constructor.call(this, this.token, this.uri, this.encoding);
    }
    ...
    HttpNodeWrapper.prototype.request = function(request, token, uri, encoding, callback) {
      var parts;
      if (uri == null) {
