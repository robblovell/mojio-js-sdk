...
module.exports = class MojioClient
    ...
    _app: (callback) -> # Use if you want the raw result of the call.
    ...
    ###
       Mojio
    ###
    mojios_resource: 'Mojio'

    _mojio: (callback) -> # Use if you want the raw result of the call.
    ...
    ###
       Vehicle
    ###
    vehicles_resource: 'Vehicle'

    _vehicle: (callback) -> # Use if you want the raw result of the call.
    ...
    _user: (callback) -> # Use if you want the raw result of the call.
    ...
    _trip: (callback) -> # Use if you want the raw result of the call.
