      ...
      if (!token) {
        ...
        return this.request({
          ...
          id: token
        	...
        	Ti.API.info("token call:" + this.source);
          return function(error, result) {
            if (error) {
              return callback(error, null);
            } else {
              Ti.API.info("token call:" + result);
    ...
    MojioClient.prototype.query = function(model, parameters, callback) {
      ...
      if (parameters instanceof Object) {
        ...
        return this.request({
          ...
          return function(error, result) { //I don't understand it, why another embedded func? 
