#!/bin/sh
bower install
coffee --map --compile src/js/nodejs
coffee --map --compile src/js/models
cp src/js/nodejs/*.js lib/nodejs
cp src/js/models/*.js lib/models
coffee --map --compile src/js/browser
cd src/js/browser
